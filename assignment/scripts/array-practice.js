...
let favoriteFoods = ['Catfish', 'Chickin Wings', 'Chicken Pad Thai', 'Dog']
...
console.log('Last Animal:', lastAnimal2);
...
console.log('The animals are now', colors);
